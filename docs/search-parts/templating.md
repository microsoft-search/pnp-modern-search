...
In order to use the property `IconSrc`, ensure you do dot specify a property for `File Extension` to not override the custom IconSrc. A custom icon should be a 16x16 pixel image.
