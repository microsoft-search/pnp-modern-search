    ...
    public render() {
        ...
        const persona: IPersonaProps = {
            ...
            onRenderPrimaryText: (props: IPersonaProps) => {
                return <div style={{ display: 'inline', whiteSpace: 'normal' }} dangerouslySetInnerHTML={{ __html: DomPurifyHelper.sanitizeWithStyleTags(this.props.templateService.applyDisambiguatedMgtPrefixIfNeededSync(processedProps.primaryText)) }}></div>;
            },
            onRenderSecondaryText: (props: IPersonaProps) => {
                return <div style={{ display: 'inline', whiteSpace: 'normal' }} dangerouslySetInnerHTML={{ __html: DomPurifyHelper.sanitizeWithStyleTags(this.props.templateService.applyDisambiguatedMgtPrefixIfNeededSync(processedProps.secondaryText)) }}></div>;
            },
            onRenderTertiaryText: (props: IPersonaProps) => {
                return <div style={{ display: 'inline', whiteSpace: 'normal' }} dangerouslySetInnerHTML={{ __html: DomPurifyHelper.sanitizeWithStyleTags(this.props.templateService.applyDisambiguatedMgtPrefixIfNeededSync(processedProps.tertiaryText)) }}></div>;
            },
            onRenderOptionalText: (props: IPersonaProps) => {
                return <div style={{ display: 'inline', whiteSpace: 'normal' }} dangerouslySetInnerHTML={{ __html: DomPurifyHelper.sanitizeWithStyleTags(this.props.templateService.applyDisambiguatedMgtPrefixIfNeededSync(processedProps.optionalText)) }}></div>;
            }
        };
