...
abstract class BaseTemplateService {
  ...
  private registerTemplateServices() {
    ...
    Handlebars.registerHelper('dayDiff', (date1: string, date2: string, format: string,) => {
      let dayCount = this.momentHelper(date1, format, this.CurrentLocale).diff(this.momentHelper(date2, format, this.CurrentLocale), 'days')
