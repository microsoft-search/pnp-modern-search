...
export default class SearchBoxWebPart extends BaseClientSideWebPart<ISearchBoxWebPartProps> implements IDynamicDataCallables {
    ...
    public render(): void {
        ...
        let inputValue: any = this.properties.defaultQueryKeywords.tryGetValue();
        ...
        else if (this.properties.useDynamicDataSource && this.properties.defaultQueryKeywords && this.properties.defaultQueryKeywords.reference) {
