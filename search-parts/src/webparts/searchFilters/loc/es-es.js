    ...
    return {
        ...
        PropertyPane: {
            ...
            DataFilterCollection: {
                ...
                FilterLimitReachedWarningMessage: "La API devolvió {0} valor(es), igualando o superando el límite configurado de {1}. Es posible que se hayan truncado valores adicionales.",
