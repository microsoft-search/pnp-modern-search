    ...
    return {
        ...
        PropertyPane: {
            ...
            DataFilterCollection: {
                ...
                FilterLimitReachedWarningMessage: "L'API ha restituito {0} valore/i, raggiungendo o superando il limite configurato di {1}. Potrebbero essere stati troncati altri valori.",
