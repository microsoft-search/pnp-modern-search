define([], function() {
    return {
        ...
        "ResultSourceIdLabel": "Identifiant / Nom (Niveau/Nom) de l'origine de résultats",
        "ResultSourceIdDescription": "Lorsque vous utilisez le nom, utilisez le format: Niveau source | Nom (c'est-à-dire: SPSite | Mes actualités). Les niveaux valides sont: SPSiteSubscription, SPSite, SPWeb",
