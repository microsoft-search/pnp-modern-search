define([], function() {
    return {
        ...
        PropertyPane: {
            DataSourcePage: {
                ...
                TemplateSlots: {
                    ...
                    MissingSlotsMessage: "Faltan ranuras en la plantilla de diseño: {0}",
            ...
            LayoutPage: {
                ...
                MissingSlotsMessage: "Las siguientes ranuras no se han configurado: {0}",
                ...
                Handlebars: {
                    ...
                    SelectionPreservedOnEmptyClick: "Mantener selección en clic vacío",
        ...
        Styling: {
            ...
            ResultsBackgroundColorLabel: "Color de fondo de los resultados",
            ResultsBorderColorLabel: "Color de borde de los resultados",
            ResultsBorderThicknessLabel: "Grosor de borde de los resultados",
