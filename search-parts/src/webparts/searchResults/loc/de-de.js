define([], function () {
    return {
        ...
        PropertyPane: {
            DataSourcePage: {
                ...
                TemplateSlots: {
                    ...
                    MissingSlotsMessage: "Fehlende Slots in der Layoutvorlage gefunden: {0}",
            ...
            LayoutPage: {
                ...
                MissingSlotsMessage: "Die folgenden Slots sind nicht konfiguriert: {0}",
                ...
                Handlebars: {
                    ...
                    SelectionPreservedOnEmptyClick: "Auswahl bei leerem Klick beibehalten",
        ...
        Styling: {
            ...
            ResultsBackgroundColorLabel: "Ergebnisse-Hintergrundfarbe",
