define([], function() {
    return {
        ...
        PropertyPane: {
            DataSourcePage: {
                ...
                TemplateSlots: {
                    ...
                    MissingSlotsMessage: "Znaleziono brakujące gniazda w szablonie układu: {0}",
            ...
            LayoutPage: {
                ...
                MissingSlotsMessage: "Następujące gniazda nie zostały skonfigurowane: {0}",
                ...
                Handlebars: {
                    ...
                    SelectionPreservedOnEmptyClick: "Zachowaj wybór przy pustym kliknięciu",
        ...
        Styling: {
            ...
            ResultsBackgroundColorLabel: "Kolor tła wyników",
