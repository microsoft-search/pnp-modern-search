define([], function() {
    return {
        ...
        PropertyPane: {
            DataSourcePage: {
                ...
                TemplateSlots: {
                    ...
                    MissingSlotsMessage: "Encontradas ranhuras em falta no modelo de layout: {0}",
            ...
            LayoutPage: {
                ...
                MissingSlotsMessage: "As seguintes ranhuras não foram configuradas: {0}",
        ...
        Styling: {
            ...
            ResultsBackgroundColorLabel: "Cor de fundo dos resultados",
            ResultsBorderColorLabel: "Cor da borda dos resultados",
            ResultsBorderThicknessLabel: "Espessura da borda dos resultados",
