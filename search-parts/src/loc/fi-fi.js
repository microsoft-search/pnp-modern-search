    ...
    return {
        ...
        General: {
            ...
            DatePickerStrings: {
                ...
                closeButtonAriaLabel: 'Sulje kalenteri',
                isRequiredErrorMessage: 'Määritä aloituspäivä.',
                invalidInputErrorMessage: 'Virheellinen päivämäärän muotoilu.'
            },
            DateIntervalStrings: {
                AnyTime: "Milloin tahansa",
                PastDay: "Edelliset 24 tuntia",
                PastWeek: "Viime viikolla",
                PastMonth: "Viime kuussa",
                Past3Months: "Viimeiset 3 kuukautta",
                PastYear: "Viime vuosi",
                Older: "Yli vuoden vanha"
            },
            SameTabOpenBehavior: "Avaa samaan välilehteen",
            NewTabOpenBehavior: "Avaa uuteen välilehteen",
            PageOpenBehaviorLabel: "Avautumistapa",
            EmptyFieldErrorMessage: "Tämä kenttä on pakollinen"
        },
        DataSources: {
            SharePointSearch: {
        ...
        HandlebarsHelpers: {
            CountMessageLong: "<b>{0}</b> tulosta haulle '<em>{1}</em>'",
        ...
        Filters: {
            ApplyAllFiltersButtonLabel: "Käytä",
            ClearAllFiltersButtonLabel: "Tyhjennä",
            FilterNoValuesMessage: "Ei tuloksia tälle suodattimelle",
            OrOperator: "TAI",
            AndOperator: "JA",
