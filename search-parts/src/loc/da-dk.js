    ...
    return {
        ...
        DataSources: {
            SharePointSearch: {
                ...
                HitHighlightedPropertiesFieldLabel:"Egenskaber for Hit fremhævet",
                HitHighlightedPropertiesFieldDescription:"Angiver de fremhævede egenskaber, der skal hentes fra søgeresultaterne. Du skal tilføje 'HitHighlightedProperties' i 'Vælg egenskaber', når du vil bruge det",
