    ...
    return {
      Tokens: {
        ...
        Custom: {
          ...
          CustomValuePlaceholder: "Angi en verdi...",
      ...
      General: {
        ...
        Extensibility: {
          ...
          LayoutDefinitionNotFound: "Den tilpasssede layouten med nøkkelen '{0}' ble ikke funnet. Se til at løsningen er korrekt deployert i appkatalogen og at manifest-ID er registrert for denne nettdelen.",
          InvalidLayoutInstance: "Den valgte layouten '{0}' implementerer ikke den abstrakte klassen 'BaseLayout' korrekt. Noen metoder mangler.",
      ...
      Layouts: {
        ...
        DetailsList: {
          ...
          ManageDetailsListColumnDescription: "Legg til, oppdater eller fjern kolonner fra detaljert liste-layouten. Du kan enten bruke egenskapsverdien i listen direkte uten omforming, eller du kan bruke et Handlebars-uttrykk som verdi. HTML støttes også i alle felt.",
